...
PageBase {
    ...
    ColumnLayout {
        ...
        ItemList {
            ...
            placeholderText: I18n.tr("Searching for devices…")
            ...
            delegate: Item {
                ...
                RowLayout {
                    ...
                    ColumnLayout {
                        ...
                        StyledText {
                            Layout.fillWidth: true
                            text: newDevice.modelData?.name || I18n.tr("Unknown device")
                            font: Tokens.font.body.small
                        ...
                        StyledText {
                            Layout.fillWidth: true
                            text: newDevice.modelData?.pairing ? I18n.tr("Pairing...") : (newDevice.modelData?.address ?? "")
                            color: Colours.palette.m3onSurfaceVariant
