...
Searcher {
    ...
    component Action: QtObject {
        ...
        readonly property string name: modelData.name ?? I18n.tr("Unnamed")
        readonly property string desc: Strings.localizeEnglishSpelling(modelData.description ?? I18n.tr("No description"))
