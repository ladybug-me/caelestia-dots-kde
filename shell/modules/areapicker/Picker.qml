...
MouseArea {
    ...
    Rectangle {
        ...
        anchors {
            left: parent.left
            top: parent.top
            leftMargin: root.rsx - border.width
            topMargin: root.rsy - border.width
        }
    ...
    Rectangle {
        ...
        implicitWidth: root.sw + root.realBorderWidth * 2
        implicitHeight: root.sh + root.realBorderWidth * 2
