...
inline QJsonObject defaultKeybinds() {
    return QJsonObject{ { "nexus", "" }, { "showall", "" }, { "dashboard", "" }, { "screenshot", "Meta+Shift+S" },
        ...
        { "kcolorpicker", "Meta+Shift+C" }, { "krohnkiteFocusUp", "" }, { "krohnkiteFocusDown", "" },
        { "krohnkiteFocusLeft", "" }, { "krohnkiteFocusRight", "" }, { "krohnkiteShiftUp", "" },
        { "krohnkiteShiftDown", "" }, { "krohnkiteShiftLeft", "" }, { "krohnkiteShiftRight", "" },
        { "krohnkiteCloseWindow", "" }, { "krohnkiteFocusNext", "" }, { "krohnkiteFocusPrev", "" },
