...
Singleton {
    ...
    onDndChanged: {
        ...
        if (dnd)
            Toaster.toast(I18n.tr("Do not disturb enabled"), I18n.tr("Popup notifications are now disabled"), "do_not_disturb_on");
        else
            Toaster.toast(I18n.tr("Do not disturb disabled"), I18n.tr("Popup notifications are now enabled"), "do_not_disturb_off");
    }
