...
namespace UI {
    ...
    // Asks whether the user also wants the optional app theming (VSCode/Zed/
    // Spicetify/Discord/Todoist/Firefox). Yes enables the Applications
    // toggles; Esc cancels the whole install.
